...
/* YOUTUBE = Highlight MLBB
   WHATSAPP = https://wa.me/6281327242447
   GITHUB = github.com/Nekorey
*/
...
const ytabilbotz = "6281327242447@s.whatsapp.net"
const txt = mek.message.conversation
const botNumber = abilbotz.user.jid
const ownerNumber = [`${owner}@s.whatsapp.net`, `6281327242447@s.whatsapp.net`, `6281327242447@s.whatsapp.net`]
...
const katalog = (teks) => {
res = abilbotz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "SagiriChan😈", "thumbnail": fs.readFileSync('pee.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
abilbotz.relayWAMessage(res)}
const fakeyt = (teks) => { 
abilbotz.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `© Radi`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://tps.com/channel/UCJPqI5eVhKPXPL2V8y6pIDA", "thumbnail": fs.readFileSync('pee.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281327242447-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} }
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "© Radi", 'jpegThumbnail': fs.readFileSync('pee.jpg')}}}
...
➛ Minat ? Pc Wa.me/6281327242447

𝗝𝗜K𝗔 𝗕𝗘𝗥𝗠𝗜𝗡𝗔𝗧...
Silahkan Hubungi Owner 🙏
Wa.me/6281327242447
( RADI STORE ) - ( SAGIRICHAN )`
but = [
...
╰────
╭─[ *MINAT CHAT* ]
│❏ wa.me/6281327242447?text=buy+premium
╰────
╭─[ *TES BOT? PC OWNER* ]
│❏  Wa.me/6281327242447
╰────
...
╰────
╭─[ *MINAT CHAT* ]
│❏ wa.me/6281327242447?text=sewa+bot
╰────
╭─[ *TES BOT? PC OWNER* ]
│❏  Wa.me/6281327242447
╰────
...
case 'groupbot':
reply(`https://chat.whatsapp.com/BWveqUBNPsVAVvGrw1TVaS`)
break
